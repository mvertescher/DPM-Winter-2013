...
public class GridMap {
	...
	/**
	 * Rebuilds the outer edges of the grid
	 */
	public void rebuildEdges() {
		for (int i = 0; i < 12; i++) {
			this.restoreNeighbor(-15,(30*i-15));
			this.restoreNeighbor(315,(30*i-15));
		}
		for (int i = 1; i < 11; i++) {
			this.restoreNeighbor((30*i-15),-15);
			this.restoreNeighbor((30*i-15),315);
		}
	}
