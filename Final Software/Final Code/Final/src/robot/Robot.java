...
public class Robot {
	...
	public void begin() {
		...
		//snooze(100000);
		//this.turnImmediatelyBy(-1);
		//snooze(5000);
		//this.turnImmediatelyBy(2);
	...
	public void shoot() { 
		...
		*/
		...
		//this.moveForwardToPoint(shootingLocationForFinal());
		this.turnToTarget();
		...
		this.navigator.travelForwardsToPoint(curPoint);
		snooze(500);
		this.navigator.travelForwardsToPoint(curPoint);
	}
	...
	public void retrieveBall(int n) {
		...
		double backup2 = 2.5; //Small backup
		...
		if (bdp.getX() == -30) {
			...
			this.navigator.turnToHeading(90 + deltaTurn); //FELEZ DO NOT Mess WITH THIS line., feliz! feliz, please...
		}	
	...
	public boolean isAttacker() {
		return sp.isAttacker();
	}


	public boolean inRange(Point a, Point b, int radius) {
