 ...
 */
public class LightSensorTimer implements TimerListener, DuelSensorTimer {
	...
	public LightSensorTimer(SensorID sid, SensorPort s, double x, double y) {
		...
		this.lsTimer = new Timer(Constants.LIGHT_SENSOR_PERIOD, this);
	...
	public boolean flag() {
		...
		//	snooze(1000);
		//Differential 
		this.hitLock = ((this.currentValue - this.previousValue) >  Constants.LIGHT_SENSOR_DIFFERENTIAL); //20
		return this.hitLock;
	}
